...
namespace RTSEngine
{
    public class BuildingPlacement : MonoBehaviour
    {
        ...
        [SerializeField]
        private float rotationSpeed = 90f; //how fast is the rotation?
        ...
        void MoveBuilding()
        {
                ...
                out RaycastHit hit, Mathf.Infinity, gameMgr.TerrainMgr.GetGroundTerrainMask()))
            {
                ...
                nextBuildingPos.x = Mathf.Round(nextBuildingPos.x);
                nextBuildingPos.z = Mathf.Round(nextBuildingPos.z);
        ...
        private void RotateBuilding()
        {
            ...
            nextEulerAngles.y += rotationSpeed * (Input.GetKeyDown(positiveRotationKey) ? 90.0f : (Input.GetKeyDown(negativeRotationKey) ? -90.0f : 0.0f));
