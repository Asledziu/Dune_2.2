...
namespace RTSEngine
{
    ...
    public class Wander : MonoBehaviour
    {
        ...
        {
            Debug.Log("test");
            if (isActive == true || unit.HealthComp.IsDead() == false || !RTSHelper.IsLocalPlayer(unit)) //if this is not enabled or this is a multiplayer game where this is not the local player's unit
                return; //do not proceed
